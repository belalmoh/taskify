...
export const CreateBoardCard = ({ onClick }: { onClick?: () => void }) => {
    return (
        <button onClick={onClick} className="flex h-24 flex-col items-center justify-center gap-1 rounded bg-column hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 transition-colors text-muted-foreground hover:text-foreground cursor-pointer">
